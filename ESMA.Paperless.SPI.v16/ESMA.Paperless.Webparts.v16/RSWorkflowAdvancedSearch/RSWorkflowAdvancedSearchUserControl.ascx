...
<div>
    <div id="criteria" class="criteria">
        ...
        <div class="row_style">
            <div class="label_column">
                <asp:Label ID="lblVacancyNo" runat="server" CssClass="label_span" Text="Vacancy Number:"></asp:Label>
            </div>
             <div class="input_column">
                <asp:TextBox ID="txtVacancyNo" runat="server" CssClass="input_text" />&nbsp;
            </div>
        </div>
        <!--PERSONAL FILE-->
        <div class="row_style">
            ...
            <div class="input_column">
                <asp:TextBox ID="txtPersonalFile" runat="server" CssClass="input_text" />&nbsp;
            </div>
        </div>
        <!--INCIDENT TICK-->
        <div class="row_style">
