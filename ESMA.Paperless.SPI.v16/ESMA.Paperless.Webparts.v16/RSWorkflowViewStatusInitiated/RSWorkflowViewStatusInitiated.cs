...
namespace ESMA.Paperless.Webparts.v16.RSWorkflowViewStatusInitiated
{
    [ToolboxItemAttribute(false)]
    public class RSWorkflowViewStatusInitiated : WebPart
    {
        // Visual Studio might automatically update this path when you change the Visual Web Part project item.
        private const string _ascxPath = @"~/_CONTROLTEMPLATES/15/ESMA.Paperless.Webparts.v16/RSWorkflowViewStatusInitiated/RSWorkflowViewStatusInitiatedUserControl.ascx";
