...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="RSWorkflowViewAllUserControl.ascx.cs" Inherits="ESMA.Paperless.Webparts.v15.RSWorkflowViewAll.RSWorkflowViewAllUserControl" %>
