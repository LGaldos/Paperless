<%@ Assembly Name="ESMA.Paperless.Webparts.v15, Version=1.0.0.0, Culture=neutral, PublicKeyToken=2ca9af153a3279a1" %>
...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="RSWorkflowViewSignedUserControl.ascx.cs" Inherits="ESMA.Paperless.Webparts.v15.RSWorkflowViewSigned.RSWorkflowViewSignedUserControl" %>
