...
namespace ESMA.Paperless.Reports.v16.RSWorkflowReports
{
    ...
    public class RSWorkflowReports : WebPart
    {
        // Visual Studio might automatically update this path when you change the Visual Web Part project item.
        private const string _ascxPath = @"~/_CONTROLTEMPLATES/15/ESMA.Paperless.Reports.v16/RSWorkflowReports/RSWorkflowReportsUserControl.ascx";
